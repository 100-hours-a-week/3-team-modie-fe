...
const KAKAO_AUTH_URL = `https://kauth.kakao.com/oauth/authorize?client_id=%VITE_KAKAO_REST_API_KEY%redirect_uri=%VITE_KAKAO_REDIRECT_URI_DEV%&response_type=code`;
