...
export default function ToastMsg({ active, description }: ToastMsgProps) {
  return (
    <>
      <div
        className={`px-6 h-[3.1rem] rounded-3xl flex justify-center items-center shrink-0 bg-black text-white opacity-0 translate-y-2 transition-all duration-500 ease-in-out
